...
def _get_version_summary():
    """Get version summary of ``czekitout``.
    ...
    -------
    summary : `str`
        Version summary of ``czekitout``.
    """
    # Check versions of czekitout.
    from . import _version
    if _version.version != version:
        raise ValueError("czekitout version has changed since "
                         "installation/compilation")



    # Generate summary.
    summary = ("czekitout {czekitout_ver!s};\n"
               "git revision {git_rev!s} using\n"
               "python {python_ver!s}")
    
    summary = summary.format(czekitout_ver=full_version,
