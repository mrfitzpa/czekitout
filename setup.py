r"""The setup script for the ``czekitout`` library.
"""
...
# For setting up czekitout package.
...
def get_git_revision():
    """Get revision hash of ``czekitout`` from git.
    ...
    -------
    revision : `str`
        Git revision hash of ``czekitout``.
    """
...
def get_version_info():
    """Get version of ``czekitout`` from git.
...
def write__version_py(full_version,
    ...
    content = ("#!/usr/bin/env python\n"
               ...
               + "information about the\n# version of czekitout currently "
...
def clean():
    if sys.platform.startswith("win"):
        ...
        os.system("rmdir /s /q ./czekitout.egg-info")
        os.system("del /q ./*.pyc")
        os.system("del /q ./*.tgz")
        os.system("del /q ./czekitout/_version.py")
    else:
        os.system("rm -vrf ./build ./dist ./*.pyc "
                  "./*.tgz ./*.egg-info ./czekitout/_version.py")
...
def setup_package():
    ...
    description = \
        ("Contains a collection of functions that facilitate type-checking, "
         "validation, and type-conversions, with useful error messages when "
         "exceptions are thrown.")

    setup(name="czekitout",
